<x-layouts.guest title="{{ __('Page not found') }}">
    <section class="wrapper bg-light">
        <div class="container pt-12 pt-md-14 pb-14 pb-md-16">
            <div class="row">
                <div class="col-lg-9 col-xl-8 mx-auto">
                    <figure class="mb-10"><img class="img-fluid" src="{{ asset('assets/img/404.png') }}" srcset="{{ asset('assets/img/404@2x.png') }} 2x" alt=""></figure>
                </div>
