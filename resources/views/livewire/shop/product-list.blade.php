<div class="row gy-10">
    ...
    <aside class="col-lg-3 sidebar">
        ...
        <div class="widget">
            <h4 class="widget-title mb-3">{{ __('Categories') }}</h4>
        ...
        <div class="widget">
            ...
            <div class="mb-3">
                <label for="maxPrice" class="form-label">{{ __('Max. price') }}: ({{ format_currency($maxPrice) }})</label>
        ...
        {{-- RATING SZŰRŐ --}}
        <div class="widget">
            <h4 class="widget-title mb-3">{{ __('Rating') }}</h4>
            ...
            @for ($i = 5; $i >= 1; $i--)
                <div class="form-check mb-1">
                    ...
                    <label class="form-check-label" for="rating{{ $i }}">
                        <span class="ratings five"></span> ({{ $i }} {{ __('stars') }})
                    </label>
                </div>
            @endfor
        </div>
    ...
    <div class="col-lg-9 order-lg-2">
        ...
        <div class="row align-items-center mb-10 position-relative zindex-1">
            <div class="col-md-7 col-xl-8 pe-xl-20">
                ...
                <h2 class="display-6 mb-1">{{ __('Products') }}</h2>
        ...
        <div class="grid grid-view projects-masonry shop mb-13">
            <div class="row gx-md-8 gy-10 gy-md-13 isotope">
                @forelse($products as $product)
                    <x-partials.guest.shop.product :product="$product"/>
                @empty
                    {{-- A szűrőnek megfelelő termék nem található. --}}
                    <p class="alert alert-info">{{ __('No products matching the criteria were found') }}</p>
                @endforelse
            </div>
        </div>
