...
<div class="project item col-md-6 col-xl-3">
    <figure class="rounded mb-6">
        ...
        @auth
            <a class="item-like" href="#" data-bs-toggle="white-tooltip" title="{{ __('Add to wishlist') }}">
                <i class="uil uil-heart"></i>
            </a>
            <a class="item-view" href="#" data-bs-toggle="white-tooltip" title="{{ __('Quick view') }}">
    ...
    <div class="post-header">
        ...
        <h2 class="post-title h3 fs-22">
            <a href="./shop-product.html" class="link-dark">{{ $product->name }}</a>
        </h2>
        <p class="price">
            <span class="amount">{{ format_currency($product->price) }}</span>
        </p>
    </div>
</div>
